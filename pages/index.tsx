  ...
  return (
    ...
    <Note>
     ...
     <h1 className="text-4xl font-bold">
      ...
      <Link className="px-4 py-2 bg-red-500 text-xl text-white block mx-auto y-2" href="https://nowpayments.io/payment/?iid=4425132678">Buy DPOSVG Tokens via Crypto!</Link>
    </div></Note>
    </>
  );
}
